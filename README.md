...
Открой **Wani Notebook** в меню расширений или плавающей кнопкой **Notebook**. Если установлен Roleplay Tools версии 0.1.0, блокнот автоматически появляется на странице **Блокнот**. Его можно перенести к другим блокам через настройки Roleplay Tools. Обновлять остальные расширения для подключения не требуется.
...
Меню Tavern дополнительно проверяется с настоящими стилями и шрифтами установленной Tavern: пройдены 19 проверок оформления, наведения, смены темы и открытия мышью/клавиатурой — с Roleplay Tools и без него.
